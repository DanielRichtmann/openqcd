...
* File frcfcts.c
*
* Copyright (C) 2005, 2011-2016, 2018 Martin Luescher, Stefan Schaefer
*
...
* locally called. If SSE (AVX) instructions are used, the Pauli matrices and
* the spinors must be aligned to a 16 (32) byte boundary.
*
*******************************************************************************/
